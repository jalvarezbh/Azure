...
namespace ru.core.integrations.customer.core.Model.Dataverse
{
	...
	[System.Runtime.Serialization.DataContractAttribute()]
	[System.CodeDom.Compiler.GeneratedCodeAttribute("Dataverse Model Builder", "2.0.0.16")]
	public enum rub_account_rub_triggeraction
	{
		...
		[System.Runtime.Serialization.EnumMemberAttribute()]
		UpdateAccountAssortmentGroups = 915030001,
	}
	...
	public enum account_statuscode
	{
		...
		[System.Runtime.Serialization.EnumMemberAttribute()]
		DeactivationRequested = 915030002,
	}
	...
	public partial class Account : Microsoft.Xrm.Sdk.Entity
	{
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("rub_accountsegment")]
		public Microsoft.Xrm.Sdk.EntityReference rub_accountsegment
		{
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("rub_accountsegment");
			}
			set
			{
				this.SetAttributeValue("rub_accountsegment", value);
			}
		}
		
		/// <summary>
		/// Baltics Sales Specific
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("rub_accountsegment2")]
		public Microsoft.Xrm.Sdk.EntityReference rub_accountsegment2
		{
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("rub_accountsegment2");
			}
			set
			{
				this.SetAttributeValue("rub_accountsegment2", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("rub_accounttype")]
		public virtual rub_accounttype? rub_accounttype
		{
			get
			{
				return ((rub_accounttype?)(EntityOptionSetEnum.GetEnum(this, "rub_accounttype")));
			}
			set
			{
				this.SetAttributeValue("rub_accounttype", value.HasValue ? new Microsoft.Xrm.Sdk.OptionSetValue((int)value) : null);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("rub_address1_country")]
		public virtual rub_country? rub_address1_country
		{
			get
			{
				return ((rub_country?)(EntityOptionSetEnum.GetEnum(this, "rub_address1_country")));
			}
			set
			{
				this.SetAttributeValue("rub_address1_country", value.HasValue ? new Microsoft.Xrm.Sdk.OptionSetValue((int)value) : null);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("rub_annualvolume")]
		public System.Nullable<int> rub_annualvolume
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<int>>("rub_annualvolume");
			}
			set
			{
				this.SetAttributeValue("rub_annualvolume", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("rub_branchnumber")]
		public string rub_branchnumber
		{
			get
			{
				return this.GetAttributeValue<string>("rub_branchnumber");
			}
			set
			{
				this.SetAttributeValue("rub_branchnumber", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("rub_chain")]
		public Microsoft.Xrm.Sdk.EntityReference rub_chain
		{
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("rub_chain");
			}
			set
			{
				this.SetAttributeValue("rub_chain", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("rub_chainformat")]
		public Microsoft.Xrm.Sdk.EntityReference rub_chainformat
		{
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("rub_chainformat");
			}
			set
			{
				this.SetAttributeValue("rub_chainformat", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("rub_classification")]
		public Microsoft.Xrm.Sdk.EntityReference rub_classification
		{
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("rub_classification");
			}
			set
			{
				this.SetAttributeValue("rub_classification", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("rub_commentsfrommarketingside")]
		public string rub_commentsfrommarketingside
		{
			get
			{
				return this.GetAttributeValue<string>("rub_commentsfrommarketingside");
			}
			set
			{
				this.SetAttributeValue("rub_commentsfrommarketingside", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("rub_commentsfromsalesside")]
		public string rub_commentsfromsalesside
		{
			get
			{
				return this.GetAttributeValue<string>("rub_commentsfromsalesside");
			}
			set
			{
				this.SetAttributeValue("rub_commentsfromsalesside", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("rub_competivebrand")]
		public Microsoft.Xrm.Sdk.EntityReference rub_competivebrand
		{
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("rub_competivebrand");
			}
			set
			{
				this.SetAttributeValue("rub_competivebrand", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("rub_currentsupplier")]
		public Microsoft.Xrm.Sdk.EntityReference rub_currentsupplier
		{
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("rub_currentsupplier");
			}
			set
			{
				this.SetAttributeValue("rub_currentsupplier", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("rub_customercategory")]
		public Microsoft.Xrm.Sdk.EntityReference rub_customercategory
		{
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("rub_customercategory");
			}
			set
			{
				this.SetAttributeValue("rub_customercategory", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("rub_deactivationdate")]
		public System.Nullable<System.DateTime> rub_deactivationdate
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<System.DateTime>>("rub_deactivationdate");
			}
			set
			{
				this.SetAttributeValue("rub_deactivationdate", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("rub_donotvisit")]
		public System.Nullable<bool> rub_donotvisit
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<bool>>("rub_donotvisit");
			}
			set
			{
				this.SetAttributeValue("rub_donotvisit", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("rub_emailaddressorders")]
		public string rub_emailaddressorders
		{
			get
			{
				return this.GetAttributeValue<string>("rub_emailaddressorders");
			}
			set
			{
				this.SetAttributeValue("rub_emailaddressorders", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("rub_externalkey")]
		public string rub_externalkey
		{
			get
			{
				return this.GetAttributeValue<string>("rub_externalkey");
			}
			set
			{
				this.SetAttributeValue("rub_externalkey", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("rub_image")]
		public Microsoft.Xrm.Sdk.EntityReference rub_image
		{
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("rub_image");
			}
			set
			{
				this.SetAttributeValue("rub_image", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("rub_lastvisitdate")]
		public System.Nullable<System.DateTime> rub_lastvisitdate
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<System.DateTime>>("rub_lastvisitdate");
			}
			set
			{
				this.SetAttributeValue("rub_lastvisitdate", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("rub_legalname")]
		public string rub_legalname
		{
			get
			{
				return this.GetAttributeValue<string>("rub_legalname");
			}
			set
			{
				this.SetAttributeValue("rub_legalname", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("rub_nielsenid")]
		public string rub_nielsenid
		{
			get
			{
				return this.GetAttributeValue<string>("rub_nielsenid");
			}
			set
			{
				this.SetAttributeValue("rub_nielsenid", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("rub_noofoutlets")]
		public System.Nullable<int> rub_noofoutlets
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<int>>("rub_noofoutlets");
			}
			set
			{
				this.SetAttributeValue("rub_noofoutlets", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("rub_notes")]
		public string rub_notes
		{
			get
			{
				return this.GetAttributeValue<string>("rub_notes");
			}
			set
			{
				this.SetAttributeValue("rub_notes", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("rub_outdoor")]
		public virtual rub_outdoor? rub_outdoor
		{
			get
			{
				return ((rub_outdoor?)(EntityOptionSetEnum.GetEnum(this, "rub_outdoor")));
			}
			set
			{
				this.SetAttributeValue("rub_outdoor", value.HasValue ? new Microsoft.Xrm.Sdk.OptionSetValue((int)value) : null);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("rub_packagetype")]
		public Microsoft.Xrm.Sdk.EntityReference rub_packagetype
		{
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("rub_packagetype");
			}
			set
			{
				this.SetAttributeValue("rub_packagetype", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("rub_primarydistributor")]
		public Microsoft.Xrm.Sdk.EntityReference rub_primarydistributor
		{
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("rub_primarydistributor");
			}
			set
			{
				this.SetAttributeValue("rub_primarydistributor", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("rub_salespotential")]
		public Microsoft.Xrm.Sdk.EntityReference rub_salespotential
		{
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("rub_salespotential");
			}
			set
			{
				this.SetAttributeValue("rub_salespotential", value);
			}
		}
		
		/// <summary>
		/// Number of the customer in SAP
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("rub_sap_kunnr")]
		public string rub_sap_kunnr
		{
			get
			{
				return this.GetAttributeValue<string>("rub_sap_kunnr");
			}
			set
			{
				this.SetAttributeValue("rub_sap_kunnr", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("rub_triggeraction")]
		public virtual rub_account_rub_triggeraction? rub_TriggerAction
		{
			get
			{
				return ((rub_account_rub_triggeraction?)(EntityOptionSetEnum.GetEnum(this, "rub_triggeraction")));
			}
			set
			{
				this.SetAttributeValue("rub_triggeraction", value.HasValue ? new Microsoft.Xrm.Sdk.OptionSetValue((int)value) : null);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("rub_visitfrequency")]
		public System.Nullable<int> rub_visitfrequency
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<int>>("rub_visitfrequency");
			}
			set
			{
				this.SetAttributeValue("rub_visitfrequency", value);
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("rub_volumemonthlyl")]
		public System.Nullable<int> rub_volumemonthlyl
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<int>>("rub_volumemonthlyl");
			}
			set
			{
				this.SetAttributeValue("rub_volumemonthlyl", value);
			}
		}
		...
		public System.Collections.Generic.IEnumerable<ru.core.integrations.customer.core.Model.Dataverse.Account> Referencedaccount_master_account
		{
			get
			{
				return this.GetRelatedEntities<ru.core.integrations.customer.core.Model.Dataverse.Account>("account_master_account", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.SetRelatedEntities<ru.core.integrations.customer.core.Model.Dataverse.Account>("account_master_account", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
			}
		}
		...
		public System.Collections.Generic.IEnumerable<ru.core.integrations.customer.core.Model.Dataverse.Account> Referencedaccount_parent_account
		{
			get
			{
				return this.GetRelatedEntities<ru.core.integrations.customer.core.Model.Dataverse.Account>("account_parent_account", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.SetRelatedEntities<ru.core.integrations.customer.core.Model.Dataverse.Account>("account_parent_account", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
			}
		}
		...
		public System.Collections.Generic.IEnumerable<ru.core.integrations.customer.core.Model.Dataverse.Account> Referencedmsa_account_managingpartner
		{
			get
			{
				return this.GetRelatedEntities<ru.core.integrations.customer.core.Model.Dataverse.Account>("msa_account_managingpartner", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.SetRelatedEntities<ru.core.integrations.customer.core.Model.Dataverse.Account>("msa_account_managingpartner", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
			}
		}
		...
		public System.Collections.Generic.IEnumerable<ru.core.integrations.customer.core.Model.Dataverse.Account> Referencedmsdyn_account_account_BillingAccount
		{
			get
			{
				return this.GetRelatedEntities<ru.core.integrations.customer.core.Model.Dataverse.Account>("msdyn_account_account_BillingAccount", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.SetRelatedEntities<ru.core.integrations.customer.core.Model.Dataverse.Account>("msdyn_account_account_BillingAccount", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
			}
		}
		
		/// <summary>
		/// 1:N rub_account_account_primarydistributor
		/// </summary>
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("rub_account_account_primarydistributor", Microsoft.Xrm.Sdk.EntityRole.Referenced)]
		public System.Collections.Generic.IEnumerable<ru.core.integrations.customer.core.Model.Dataverse.Account> Referencedrub_account_account_primarydistributor
		{
			get
			{
				return this.GetRelatedEntities<ru.core.integrations.customer.core.Model.Dataverse.Account>("rub_account_account_primarydistributor", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.SetRelatedEntities<ru.core.integrations.customer.core.Model.Dataverse.Account>("rub_account_account_primarydistributor", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
			}
		}
		
		/// <summary>
		/// N:N rub_account_pos_account_wholesale
		/// </summary>
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("rub_account_pos_account_wholesale", Microsoft.Xrm.Sdk.EntityRole.Referencing)]
		public System.Collections.Generic.IEnumerable<ru.core.integrations.customer.core.Model.Dataverse.Account> Referencingrub_account_pos_account_wholesale
		{
			get
			{
				return this.GetRelatedEntities<ru.core.integrations.customer.core.Model.Dataverse.Account>("rub_account_pos_account_wholesale", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
			set
			{
				this.SetRelatedEntities<ru.core.integrations.customer.core.Model.Dataverse.Account>("rub_account_pos_account_wholesale", Microsoft.Xrm.Sdk.EntityRole.Referencing, value);
			}
		}
		...
		/// N:N rub_account_pos_account_wholesale
		/// </summary>
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("rub_account_pos_account_wholesale", Microsoft.Xrm.Sdk.EntityRole.Referenced)]
		public System.Collections.Generic.IEnumerable<ru.core.integrations.customer.core.Model.Dataverse.Account> Referencedrub_account_pos_account_wholesale
		{
			get
			{
				return this.GetRelatedEntities<ru.core.integrations.customer.core.Model.Dataverse.Account>("rub_account_pos_account_wholesale", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.SetRelatedEntities<ru.core.integrations.customer.core.Model.Dataverse.Account>("rub_account_pos_account_wholesale", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
			}
		}
		...
		public ru.core.integrations.customer.core.Model.Dataverse.Account Referencingaccount_master_account
		{
			get
			{
				return this.GetRelatedEntity<ru.core.integrations.customer.core.Model.Dataverse.Account>("account_master_account", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
		}
		...
		public ru.core.integrations.customer.core.Model.Dataverse.Account Referencingaccount_parent_account
		{
			get
			{
				return this.GetRelatedEntity<ru.core.integrations.customer.core.Model.Dataverse.Account>("account_parent_account", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
			set
			{
				this.SetRelatedEntity<ru.core.integrations.customer.core.Model.Dataverse.Account>("account_parent_account", Microsoft.Xrm.Sdk.EntityRole.Referencing, value);
			}
		}
		...
		public ru.core.integrations.customer.core.Model.Dataverse.Account Referencingmsa_account_managingpartner
		{
			get
			{
				return this.GetRelatedEntity<ru.core.integrations.customer.core.Model.Dataverse.Account>("msa_account_managingpartner", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
			set
			{
				this.SetRelatedEntity<ru.core.integrations.customer.core.Model.Dataverse.Account>("msa_account_managingpartner", Microsoft.Xrm.Sdk.EntityRole.Referencing, value);
			}
		}
		...
		public ru.core.integrations.customer.core.Model.Dataverse.Account Referencingmsdyn_account_account_BillingAccount
		{
			get
			{
				return this.GetRelatedEntity<ru.core.integrations.customer.core.Model.Dataverse.Account>("msdyn_account_account_BillingAccount", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
			set
			{
				this.SetRelatedEntity<ru.core.integrations.customer.core.Model.Dataverse.Account>("msdyn_account_account_BillingAccount", Microsoft.Xrm.Sdk.EntityRole.Referencing, value);
			}
		}
		
		/// <summary>
		/// N:1 rub_account_account_primarydistributor
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("rub_primarydistributor")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("rub_account_account_primarydistributor", Microsoft.Xrm.Sdk.EntityRole.Referencing)]
		public ru.core.integrations.customer.core.Model.Dataverse.Account Referencingrub_account_account_primarydistributor
		{
			get
			{
				return this.GetRelatedEntity<ru.core.integrations.customer.core.Model.Dataverse.Account>("rub_account_account_primarydistributor", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
			set
			{
				this.SetRelatedEntity<ru.core.integrations.customer.core.Model.Dataverse.Account>("rub_account_account_primarydistributor", Microsoft.Xrm.Sdk.EntityRole.Referencing, value);
			}
		}
	}
}
